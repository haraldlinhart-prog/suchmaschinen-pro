      ...
      <section id="pricing" style={{ padding: '4rem 1.5rem', maxWidth: 1100, margin: '0 auto' }}>
        ...
        >
          <div style={{ textAlign: 'left' }}>
            <div style={{ fontSize: '0.8rem', color: 'var(--emerald-light)', fontWeight: 700, letterSpacing: '0.05em', marginBottom: '0.4rem' }}>PREMIUM · MAXIMUM SPEED</div>
            ...
            <p style={{ fontSize: '0.92rem', color: 'rgba(255,255,255,0.75)', margin: 0 }}>
              1 article every day — the fastest cadence we offer.
            </p>
          </div>
